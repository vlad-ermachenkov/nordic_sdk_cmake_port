...
set(board_defs "${board_defs} -DBOARD_PCA10056")
set(board_defs "${board_defs} -DCONFIG_GPIO_AS_PINRESET")
set(board_defs "${board_defs} -DFLOAT_ABI_HARD")
set(board_defs "${board_defs} -DNRF52840_XXAA")
set(board_defs "${board_defs} -DNRF_SD_BLE_API_VERSION=7")
set(board_defs "${board_defs} -DS140")
set(board_defs "${board_defs} -DSOFTDEVICE_PRESENT")

CONFIGURE_FILE(${SDK_ROOT}/components/softdevice/s140/hex/s140_nrf52_7.0.1_softdevice.hex ${CMAKE_CURRENT_BINARY_DIR}/s140_nrf52_7.0.1_softdevice.hex)

#Example specific#
set(example_name "ble_app_hrs_freertos")
set(sd_type "s140")
set(board_type "pca10056")
set(ld_prefix "ble_app_hrs_freertos")
set(example_folder "ble_peripheral")